...
> Índice ao vivo das ferramentas LLMOps mais recentes — acompanhe o que está sendo lançado em observabilidade e deploy de LLMs
...
Um tracker em atualização contínua que descobre, cataloga e pontua novas ferramentas LLMOps conforme elas aparecem no GitHub e no Product Hunt. Diferente das listas estáticas no estilo awesome-list, ele roda diariamente via GitHub Actions para trazer à tona ferramentas lançadas na última semana em categorias como observabilidade, gerenciamento de prompts, rastreamento de custos e gateways.
...
4. Commita `feat: +N added, -M removed (timestamp)` se algo mudou.
