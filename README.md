...
| 18 | [mlflow/mlflow](https://github.com/mlflow/mlflow) | 27118 | Python | 2026-07-21 | The open source AI engineering platform for agents, LLMs, and ML models. MLflow enables teams of all sizes to debug, eva |
| 19 | [acornops/management-console](https://github.com/acornops/management-console) | 2 | TypeScript | 2026-07-21 | Management console for AcornOps, providing the browser UI for workspaces, targets, runs, agents, and platform operations |
| 20 | [cloudrift-ai/emmy](https://github.com/cloudrift-ai/emmy) | 66 | Python | 2026-07-21 | Benchmark and deploy optimized LLM models on GPU servers with vLLM or SGLang. Chose from a list of optimized recipes for |
| 21 | [promptfoo/promptfoo](https://github.com/promptfoo/promptfoo) | 23446 | TypeScript | 2026-07-21 | Test your prompts, agents, and RAGs. Red teaming/pentesting/vulnerability scanning for AI. Compare performance of GPT, C |
| 22 | [Arize-ai/phoenix](https://github.com/Arize-ai/phoenix) | 10642 | Python | 2026-07-21 | AI Observability & Evaluation |
...
| 25 | [w8123/EnterpriseAgentFramework](https://github.com/w8123/EnterpriseAgentFramework) | 484 | Java | 2026-07-20 | 面向 OA、ERP、CRM、工单等企业系统快速构建智能体，让 AI 在权限、审计与治理约束下安全调用真实业务能力。Build agents quickly for enterprise systems such as OA, ERP, CR |
| 26 | [0xPlaygrounds/rig](https://github.com/0xPlaygrounds/rig) | 7996 | Rust | 2026-07-20 | ⚙️🦀 Build modular and scalable LLM Applications in Rust |
| 27 | [runcycles/cycles-dashboard](https://github.com/runcycles/cycles-dashboard) | 0 | TypeScript | 2026-07-21 | AI agent governance dashboard for Cycles — budgets, action authority, tenants, webhooks, reservations, audit |
