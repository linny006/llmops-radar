...
| 13 | [langwatch/langwatch](https://github.com/langwatch/langwatch) | 4857 | TypeScript | 2026-09-22 | The platform for LLM evaluations and AI agent testing |
| 14 | [Guillain-RDCDE/Trusted-Transcription](https://github.com/Guillain-RDCDE/Trusted-Transcription) | 0 | Python | 2026-09-22 | Catches an AI's confident mistakes before they reach a client — what turns an impressive demo into something you can inv |
| 15 | [Ort0x36/deprecation-desk](https://github.com/Ort0x36/deprecation-desk) | 0 | Python | 2026-09-22 | Know which of your model calls are on a clock. |
| 16 | [sxueck/llm-gateway](https://github.com/sxueck/llm-gateway) | 52 | TypeScript | 2026-09-22 | Lightweight distributed LLM gateway w/ web UI for model mgmt & routing. Supports vibe programming, prompt opt., & optimi |
...
| 30 | [acr3463/systemprompt-demo](https://github.com/acr3463/systemprompt-demo) | 0 | — | 2026-09-22 | Manage Claude Desktop and Claude Cowork through an audited gateway with full visibility into prompts, tool calls, and co |
| 31 | [Unadventurous-concertina802/arcadia-win-script-execute](https://github.com/Unadventurous-concertina802/arcadia-win-script-execute) | 0 | HTML | 2026-09-22 | Execute Roblox Lua scripts on Windows with this compact, keyless runner featuring a built-in library of over 500 scripts |
| 32 | [jakbuczarnecki/intergrax](https://github.com/jakbuczarnecki/intergrax) | 4 | Python | 2026-09-22 | Source-available operating layer for governed AI applications — reuse policy, authority, evidence, execution, and recove |
...
| 34 | [rknightion/genai-otel-bridge](https://github.com/rknightion/genai-otel-bridge) | 1 | Go | 2026-09-22 | Turn Portkey and LangSmith LLM traffic into OpenTelemetry metrics and logs. Vendor-neutral OTLP to Grafana Cloud or any  |
| 35 | [api-evangelist/zenml](https://github.com/api-evangelist/zenml) | 0 | — | 2026-09-22 | ZenML — independent third-party profile of a public API surface, by API Evangelist. ZenML is an open-source MLOps and LL |
...
| 37 | [montgome753/LLM-Evaluation-Framework](https://github.com/montgome753/LLM-Evaluation-Framework) | 0 | Python | 2026-09-22 | Benchmark LLM accuracy, latency, cost, and hallucination rates across models with this open-source evaluation suite. |
| 38 | [Roseapplemutualopposition5427/rag-llamaindex-qdrant-docker](https://github.com/Roseapplemutualopposition5427/rag-llamaindex-qdrant-docker) | 0 | Dockerfile | 2026-09-22 | Build a multi-collection RAG system using LlamaIndex and Qdrant in a Docker environment. |
| 39 | [psyb0t/aigate](https://github.com/psyb0t/aigate) | 13 | Shell | 2026-09-22 | A self-hosted AI platform — inference, tool use, browser automation, image generation, speech synthesis, transcription,  |
...
| 41 | [rhesis-ai/rhesis](https://github.com/rhesis-ai/rhesis) | 392 | Python | 2026-09-22 | The collaboration layer for AI teams: domain experts annotate and review agent behavior, engineers improve the agent fro |
| 42 | [Healthful-article791/rag-systems-production](https://github.com/Healthful-article791/rag-systems-production) | 1 | — | 2026-09-22 | Build production-ready RAG systems with document ingestion, vector search, LLM integration, and enterprise monitoring fo |
| 43 | [api-evangelist/tensorzero](https://github.com/api-evangelist/tensorzero) | 0 | — | 2026-09-22 | TensorZero — independent third-party profile of a public API surface, by API Evangelist. TensorZero is an open-source, s |
| 44 | [sarkarbikram90/airun-profiler](https://github.com/sarkarbikram90/airun-profiler) | 3 | Python | 2026-09-22 | An open-source AI infrastructure profiler that connects AI workload telemetry to physical infrastructure behavior and ec |
| 45 | [ivanmoralesf2015-sudo/enterprise-governance-toolkit](https://github.com/ivanmoralesf2015-sudo/enterprise-governance-toolkit) | 0 | — | 2026-09-22 | Provide frameworks to establish leadership alignment, clarify decision authority, and enhance oversight for enterprise g |
| 46 | [mloda-ai/mloda](https://github.com/mloda-ai/mloda) | 88 | Python | 2026-09-22 | mloda.ai - Open Data Access for AI and ML. Plugin-based. Traceable. Framework-agnostic. |
| 47 | [wahhyun/llm-eval](https://github.com/wahhyun/llm-eval) | 1 | C++ | 2026-09-22 | Evaluate large language models with tools for performance and consistency scoring as part of the llm-cpp C++ infrastruct |
