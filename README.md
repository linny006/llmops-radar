...
| 34 | [boundflow/boundflow](https://github.com/boundflow/boundflow) | 6 | Python | 2026-08-31 | Open-source control plane for AI agents that take real actions: policy-dictated lifecycle controls, approvals, durable e |
| 35 | [laputski/causa-rag](https://github.com/laputski/causa-rag) | 1 | Python | 2026-08-31 | A diagnostic bench for RAG. Scores every question separately, names the pipeline stage that failed, and diffs two runs q |
| 36 | [mozilla-ai/otari](https://github.com/mozilla-ai/otari) | 419 | Python | 2026-08-31 | Open-source, OpenAI-compatible LLM gateway you run yourself. One endpoint for 40+ providers, with virtual keys, budgets, |
| 37 | [gmitt98/fieldtest](https://github.com/gmitt98/fieldtest) | 0 | Python | 2026-08-31 | LLM evaluation framework — define what correct, well-formed, and safe means before you measure |
| 38 | [JavisBot-Service/javis-transparency](https://github.com/JavisBot-Service/javis-transparency) | 1 | Python | 2026-08-31 | Third-party-verifiable model-authenticity audit for the javis.bot Claude/GPT relay — open-source probe, runs on GitHub A |
| 39 | [rrahimi-uci/caliber-suite](https://github.com/rrahimi-uci/caliber-suite) | 1 | Python | 2026-08-31 | Open-source MLflow plugin for AI agents and agentic workflows: prompts, tools, skills, MCP servers, RAG knowledge bases, |
| 40 | [siva010928/agnos-proxy-oss](https://github.com/siva010928/agnos-proxy-oss) | 0 | Python | 2026-08-31 | Gateway-agnostic control plane for LLMs — an OpenAI-compatible governance proxy (auth, guardrails, budgets, routing, cos |
| 41 | [brunovicco/governed-llm-gateway](https://github.com/brunovicco/governed-llm-gateway) | 0 | Python | 2026-08-31 | Governed, provider-neutral LLM gateway for deterministic model authorization, explainable routing, safe fallback, proven |
| 42 | [forger-labs-hq/researchforge](https://github.com/forger-labs-hq/researchforge) | 7 | Python | 2026-08-31 | A lab protocol for coding agents. Freeze baselines, run hypotheses in isolated worktrees, reject failures and validate i |
| 43 | [billbz99/finguard-orchestrator](https://github.com/billbz99/finguard-orchestrator) | 0 | Python | 2026-08-31 | Autonomous multi-agent AML transaction monitoring & compliance audit engine built with LangGraph, ChromaDB, FastAPI, and |
...
| 45 | [Red1-Rahman/NiriZan](https://github.com/Red1-Rahman/NiriZan) | 2 | Jupyter Notebook | 2026-08-31 | Continuous Evaluation Infrastructure for Production AI |
| 46 | [evidentlyai/evidently](https://github.com/evidentlyai/evidently) | 7868 | Jupyter Notebook | 2026-08-31 | Evidently is ​​an open-source ML and LLM observability framework. Evaluate, test, and monitor any AI-powered system or d |
| 47 | [alibaba/rtp-llm](https://github.com/alibaba/rtp-llm) | 1321 | Cuda | 2026-08-31 | RTP-LLM: Alibaba's high-performance LLM inference engine for diverse applications. |
| 48 | [bj-qizhi/trigix](https://github.com/bj-qizhi/trigix) | 4 | Rust | 2026-08-31 | AI-native workflow automation platform — Rust execution engine, 180 node types, visual canvas |
| 49 | [virinchisai/aidlc-passport](https://github.com/virinchisai/aidlc-passport) | 0 | Python | 2026-08-31 | Local-first AIDLC evidence compiler for portable, verifiable AI system release passports. |
| 50 | [Jwuthri/Tracely-ai](https://github.com/Jwuthri/Tracely-ai) | 1163 | Python | 2026-08-31 | Trace-native CI/CD for AI agents — production failures become regression tests that block the PR. Auto-detect, cluster,  |
<!-- TRACKER_TABLE_END -->
