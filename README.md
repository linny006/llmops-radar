...
| 27 | [xlabs-club/awesome-x-ops](https://github.com/xlabs-club/awesome-x-ops) | 43 | — | 2026-08-01 | A curated map of modern X-Ops: AI Ops, LLM/Agent Observability, Platform Engineering, GitOps, DataOps, FinOps, DevSecOps |
| 28 | [EffortlessMetrics/tokmd](https://github.com/EffortlessMetrics/tokmd) | 5 | Rust | 2026-08-01 | Code intelligence for humans, machines, and LLMs: receipts, metrics, and insights from your codebase. |
...
| 30 | [langwatch/langwatch](https://github.com/langwatch/langwatch) | 3450 | TypeScript | 2026-08-01 | The platform for LLM evaluations and AI agent testing |
...
| 32 | [resizes/asc-workshop](https://github.com/resizes/asc-workshop) | 5 | Vue | 2026-08-01 | Asturias Software Crafters Workshop |
| 33 | [promptfoo/promptfoo](https://github.com/promptfoo/promptfoo) | 23822 | TypeScript | 2026-08-01 | Test your prompts, agents, and RAGs. Red teaming/pentesting/vulnerability scanning for AI. Compare performance of GPT, C |
...
| 35 | [ComposioHQ/composio](https://github.com/ComposioHQ/composio) | 29493 | TypeScript | 2026-08-01 | Composio powers 1000+ toolkits, tool search, context management, authentication, and a sandboxed workbench to help you b |
| 36 | [vllm-project/vllm-ascend](https://github.com/vllm-project/vllm-ascend) | 2538 | C++ | 2026-08-01 | Community maintained hardware plugin for vLLM on Ascend |
...
| 38 | [api-evangelist/zenml](https://github.com/api-evangelist/zenml) | 0 | — | 2026-08-01 | ZenML is an open-source MLOps and LLMOps framework that unifies machine learning and generative AI workflows through a s |
| 39 | [luisroquette/ai-gym](https://github.com/luisroquette/ai-gym) | 0 | TypeScript | 2026-08-01 | 🏋️ Train your AI agents with measurement, not vibes. Eval harness + scenario rubrics + subagent judges + prompt tourname |
| 40 | [acornops/llm-gateway](https://github.com/acornops/llm-gateway) | 2 | Python | 2026-08-01 | LLM and tool gateway for AcornOps, brokering model providers, MCP tools, policy enforcement, and runtime credentials. |
| 41 | [avikalpg/byok-relay](https://github.com/avikalpg/byok-relay) | 53 | JavaScript | 2026-08-01 | Bring your own key (BYOK) relay to enable lightweight frontend-only apps to use LLMs using the user's API keys without h |
...
| 43 | [Hilalalpak/CairnOps](https://github.com/Hilalalpak/CairnOps) | 0 | Python | 2026-08-01 | CairnOps — AI-powered expedition planning engine built as an LLMOps learning project. LangGraph agent pipeline pulls rea |
| 44 | [psyb0t/aigate](https://github.com/psyb0t/aigate) | 10 | Shell | 2026-08-01 | A self-hosted AI platform — inference, tool use, browser automation, image generation, speech synthesis, transcription,  |
| 45 | [vivek-541/vivek-541](https://github.com/vivek-541/vivek-541) | 3 | HTML | 2026-08-01 | AI Engineer building production-grade ML systems \| LLMs, RAG, ML Pipelines \| Python, TensorFlow, LangChain \| Open to opp |
| 46 | [lisn0/tidal](https://github.com/lisn0/tidal) | 0 | Nunjucks | 2026-08-01 | llmcfo |
| 47 | [fkiene/llmtrim](https://github.com/fkiene/llmtrim) | 192 | Rust | 2026-08-01 | Local proxy that compresses your LLM API requests so you pay less, with no change to the answers. Trims wasted tokens fr |
| 48 | [justrunme/ai-runtime-platform](https://github.com/justrunme/ai-runtime-platform) | 1 | Python | 2026-08-01 | AI Infrastructure OS execution plane: OpenAI-compatible gateway, MCP tool governance, intent proxy, vLLM/KServe/KEDA, OI |
| 49 | [justrunme/ai-infra-control-plane](https://github.com/justrunme/ai-infra-control-plane) | 1 | Python | 2026-08-01 | AI Infrastructure OS control plane for governed private AI: policy, identity, audit, intent, MCP, FinOps, SLOs, Redis, P |
| 50 | [chowdarymcs/llm-cost-observatory](https://github.com/chowdarymcs/llm-cost-observatory) | 0 | Python | 2026-08-01 | Detect context bloat, cache misses, and model over-spend in production LLM systems. Langfuse/ClickHouse observability wi |
<!-- TRACKER_TABLE_END -->
