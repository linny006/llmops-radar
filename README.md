...
| 12 | [scttfrdmn/hf-bedrock-map](https://github.com/scttfrdmn/hf-bedrock-map) | 0 | Go | 2026-08-03 | Is a Hugging Face model already served by Amazon Bedrock? Daily-refreshed HF↔Bedrock mapping (US regions) with a free st |
...
| 14 | [ihabkhaled/ClawAI](https://github.com/ihabkhaled/ClawAI) | 21 | TypeScript | 2026-08-03 | Claw is a local-first AI control plane that runs powerful open models on your machine and connects to top LLM providers. |
...
| 30 | [prathamesh-git9/llm-gateway](https://github.com/prathamesh-git9/llm-gateway) | 0 | Python | 2026-08-03 | Self-hostable LLM inference gateway: policy routing with fallback chains, circuit breakers, semantic caching, per-tenant |
| 31 | [msanket9/stillsane](https://github.com/msanket9/stillsane) | 0 | Python | 2026-08-03 | Know when your LLM app quietly stops working. Baseline your prompts, run them on a schedule, get alerted when the output |
| 32 | [langwatch/langwatch](https://github.com/langwatch/langwatch) | 3457 | TypeScript | 2026-08-03 | The platform for LLM evaluations and AI agent testing |
...
| 35 | [Prathamg042004/tokensave](https://github.com/Prathamg042004/tokensave) | 1 | TypeScript | 2026-08-03 | Drop-in LLM proxy that cuts AI API costs 30-40% with semantic caching, cost-aware routing and multi-provider failover. |
...
| 37 | [admina-org/admina](https://github.com/admina-org/admina) | 6 | Python | 2026-08-03 | The open framework for governed AI development: EU AI Act compliance, PII redaction, MCP proxy, prompt-injection firewal |
| 38 | [JavisBot-Service/javis-transparency](https://github.com/JavisBot-Service/javis-transparency) | 1 | Python | 2026-08-03 | Third-party-verifiable model-authenticity audit for the javis.bot Claude/GPT relay — open-source probe, runs on GitHub A |
| 39 | [cuihuan/awesome-ai-gateway](https://github.com/cuihuan/awesome-ai-gateway) | 77 | HTML | 2026-08-03 | ⚡ Awesome AI Gateway — pick an AI gateway from 100+ (LiteLLM, OpenRouter, Portkey, Kong, Higress, new-api, Bifrost) by c |
| 40 | [aimd54/palan](https://github.com/aimd54/palan) | 0 | Go | 2026-08-03 | Serve GGUF models straight from any OCI registry. Daemonless, runs offline, one static binary. |
...
| 42 | [IgorGanapolsky/mac-yolo-safeguards](https://github.com/IgorGanapolsky/mac-yolo-safeguards) | 2 | JavaScript | 2026-08-03 | OS-level safeguards layer for AI agent loops — runaway-kill, timeouts & resource limits so coding agents (Claude Code, C |
...
| 44 | [agamm/llm-upgrade-bot](https://github.com/agamm/llm-upgrade-bot) | 3 | TypeScript | 2026-08-03 | Dependabot for LLM models — scans code for outdated AI model strings, opens upgrade PRs automatically |
| 45 | [Red1-Rahman/NiriZan](https://github.com/Red1-Rahman/NiriZan) | 0 | Jupyter Notebook | 2026-08-03 | Continuous Evaluation Infrastructure for Production AI |
| 46 | [OpenMachine-ai/transformer-tricks](https://github.com/OpenMachine-ai/transformer-tricks) | 220 | TeX | 2026-08-03 | A collection of tricks and tools to speed up transformer models |
| 47 | [coffeehc/xagent-docs](https://github.com/coffeehc/xagent-docs) | 1 | TypeScript | 2026-08-03 |  |
| 48 | [aroraneel/AI-Engineer](https://github.com/aroraneel/AI-Engineer) | 1 | Jupyter Notebook | 2026-08-03 | 165-day journey from Python & statistics fundamentals to production-grade AI/ML systems — SQL, classical ML, deep learni |
...
| 50 | [soapbucket/sbproxy](https://github.com/soapbucket/sbproxy) | 47 | Rust | 2026-08-03 | Self-hosted AI gateway and LLM proxy. OpenAI-compatible API for OpenAI, Anthropic, Gemini, Bedrock and 60+ providers, or |
<!-- TRACKER_TABLE_END -->
