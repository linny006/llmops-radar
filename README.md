...
| 13 | [api-evangelist/tensorzero](https://github.com/api-evangelist/tensorzero) | 0 | — | 2026-08-22 | TensorZero is an open-source, self-hosted LLMOps platform that unifies five capabilities behind one stack: a high-perfor |
| 14 | [api-evangelist/seldon](https://github.com/api-evangelist/seldon) | 0 | — | 2026-08-22 | Seldon is a Kubernetes-native MLOps platform that enables enterprises to deploy, monitor, manage, and explain machine le |
| 15 | [api-evangelist/raindrop](https://github.com/api-evangelist/raindrop) | 0 | — | 2026-08-22 | Raindrop is the monitoring and observability platform for AI agents — a "Sentry for AI agents" that discovers silent age |
| 16 | [api-evangelist/qwak](https://github.com/api-evangelist/qwak) | 0 | — | 2026-08-22 | Qwak is an end-to-end production machine learning platform that lets data science and ML engineering teams build, train, |
...
| 18 | [lokeshkundi15/enterprise-code-security-agent](https://github.com/lokeshkundi15/enterprise-code-security-agent) | 1 | Python | 2026-08-22 | Autonomous Multi-Agent Code Review & Security Pipeline built with LangGraph, FastMCP, AST Scanners, and Human-in-the-Loo |
...
| 20 | [api-evangelist/phoenix](https://github.com/api-evangelist/phoenix) | 0 | — | 2026-08-22 | Arize Phoenix is an open-source AI observability and evaluation platform built on OpenTelemetry, enabling developers to  |
| 21 | [api-evangelist/opik](https://github.com/api-evangelist/opik) | 0 | — | 2026-08-22 | Opik is an open-source LLM evaluation, testing, and tracing platform developed by Comet ML that enables developers to de |
...
| 23 | [api-evangelist/log10](https://github.com/api-evangelist/log10) | 1 | — | 2026-08-22 | Log10 is an LLMOps platform that provides REST API and SDK capabilities for capturing, logging, and managing LLM complet |
| 24 | [vllm-project/vllm-ascend](https://github.com/vllm-project/vllm-ascend) | 2681 | C++ | 2026-08-22 | Community maintained hardware plugin for vLLM on Ascend |
...
| 26 | [Red1-Rahman/NiriZan](https://github.com/Red1-Rahman/NiriZan) | 1 | Jupyter Notebook | 2026-08-22 | Continuous Evaluation Infrastructure for Production AI |
| 27 | [api-evangelist/evidently](https://github.com/api-evangelist/evidently) | 0 | — | 2026-08-22 | Evidently AI is an open-source ML and LLM observability framework licensed under Apache 2.0 that enables teams to evalua |
| 28 | [api-evangelist/dify](https://github.com/api-evangelist/dify) | 0 | — | 2026-08-22 | Dify is an open-source platform for building AI applications. We combine Backend-as-a-Service and LLMOps to streamline t |
| 29 | [umeshkedimi/aic](https://github.com/umeshkedimi/aic) | 1 | Python | 2026-08-22 | Agentic Incident Commander — an autonomous reliability control loop that detects, investigates, and safely remediates pr |
| 30 | [api-evangelist/comet](https://github.com/api-evangelist/comet) | 0 | — | 2026-08-22 | Comet is an enterprise AI/ML developer platform used by over 150,000 developers and organizations including Netflix, Ube |
...
| 38 | [Juror-AI/juror](https://github.com/Juror-AI/juror) | 176 | TypeScript | 2026-08-22 | Cheaper and better Greptile alternative runs on your own github actions. |
...
| 40 | [alexejsailer/agentic-nets](https://github.com/alexejsailer/agentic-nets) | 7 | TypeScript | 2026-08-22 | Governed multi-agent runtime for Petri-net workflows, scoped agent permissions, durable state, and replayable execution. |
| 41 | [JehanneDussert/govllm](https://github.com/JehanneDussert/govllm) | 27 | Python | 2026-08-22 | Continuous LLM governance monitoring for regulated environments - EU AI Act, GDPR, ANSSI. Self-hosted, profile-driven, n |
| 42 | [malkreide/zh-education-mcp](https://github.com/malkreide/zh-education-mcp) | 0 | Python | 2026-08-22 | MCP server for education statistics of Canton and City of Zurich (BISTA) |
| 43 | [togettoyou/zke](https://github.com/togettoyou/zke) | 76 | Go | 2026-08-22 | ZKE（Z Kubernetes Engine）：AI 原生的 Kubernetes 云操作环境，桌面式多集群控制台加受控 AIOps Agent，基于 Server + Agent 与 QUIC/mTLS，适用于私有云、混合云及边缘。 |
| 44 | [jochi2018/Soup](https://github.com/jochi2018/Soup) | 11 | Python | 2026-08-22 | Fine-tune and post-train LLMs with one command—no SSH, no config hell. |
| 45 | [Satisfiable-polopony613/EVIE-Preview-4.5B](https://github.com/Satisfiable-polopony613/EVIE-Preview-4.5B) | 0 | Python | 2026-08-22 | Retrieve multilingual visual documents with ultra-compact token embeddings from this Qwen3.5-4B-powered ColPali engine. |
| 46 | [ashrafb8962/agentic-ops-and-rag](https://github.com/ashrafb8962/agentic-ops-and-rag) | 1 | Jupyter Notebook | 2026-08-22 | Build and evaluate production-ready RAG pipelines with hands-on notebooks, templates, and proven performance strategies. |
| 47 | [sargentfragrant429/AgentAccessManager](https://github.com/sargentfragrant429/AgentAccessManager) | 0 | — | 2026-08-22 | Manage AI model access with a secure gateway featuring load balancing, rate limiting, and audit trails for OpenAI, Groq, |
...
| 49 | [SourceShift/mini-ork](https://github.com/SourceShift/mini-ork) | 28 | Python | 2026-08-22 | Ship AI-agent artifacts, not demo theater — verifier-gated, cross-family runs that learn which model wins. |
| 50 | [Guruexpl8276/LLM_Inference_Lab](https://github.com/Guruexpl8276/LLM_Inference_Lab) | 0 | Python | 2026-08-22 | Measure local LLM inference performance by tracking TTFT, TPOT, and throughput with this research-grade dashboard for Ol |
<!-- TRACKER_TABLE_END -->
