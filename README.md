...
| 24 | [impartshadow/agent-contracts](https://github.com/impartshadow/agent-contracts) | 0 | Python | 2026-06-22 | Deterministic pre/post-condition guardrails for LLM agents — no model in the loop. |
...
| 26 | [Arize-ai/phoenix](https://github.com/Arize-ai/phoenix) | 10237 | Python | 2026-06-22 | AI Observability & Evaluation |
...
| 32 | [kawaiirashi/llm-retry](https://github.com/kawaiirashi/llm-retry) | 1 | C++ | 2026-06-22 | Provide retry logic and circuit breaker functionality for C++ applications to improve fault tolerance in LLM infrastruct |
...
| 38 | [rvhn/rest-gateway-1771918257-5](https://github.com/rvhn/rest-gateway-1771918257-5) | 0 | — | 2026-06-22 | Provide a RESTful API gateway that manages authentication and controls request rates for secure and efficient traffic ha |
| 39 | [Firmancaaa/rest-gateway-1771916753-3](https://github.com/Firmancaaa/rest-gateway-1771916753-3) | 0 | — | 2026-06-22 | Provide a RESTful API gateway that manages authentication and enforces rate limiting for secure and controlled access to |
| 40 | [JumpMasters/tollgate](https://github.com/JumpMasters/tollgate) | 0 | Python | 2026-06-22 | A pre-charge spend control plane that enforces hard budgets on AI model usage. |
...
| 43 | [developersofik/greenprompt](https://github.com/developersofik/greenprompt) | 0 | TypeScript | 2026-06-22 | 🌿 Analyze and optimize AI prompt energy use, costs, and carbon footprints with real-time dashboards and expert insights. |
| 44 | [GaBySuGy/agent-guardrails](https://github.com/GaBySuGy/agent-guardrails) | 1 | Shell | 2026-06-22 | 🛡️ Enforce AI rules with Agent Guardrails, preventing breaches and ensuring compliance for your coding agents. Secure yo |
| 45 | [abhix2112/Cachet](https://github.com/abhix2112/Cachet) | 0 | Rust | 2026-06-22 | A transparent, 100%-local semantic cache for LLM APIs — drop-in proxy, one line to integrate, written in Rust |
| 46 | [Farukul-Islam/from-mlops-to-llmops](https://github.com/Farukul-Islam/from-mlops-to-llmops) | 0 | PHP | 2026-06-22 | 🔍 Explore the shift from MLOps to LLMOps with materials that simplify AI deployment and enhance document intelligence. |
| 47 | [vivek-541/vivek-541](https://github.com/vivek-541/vivek-541) | 2 | HTML | 2026-06-22 | AI Engineer building production-grade ML systems \| LLMs, RAG, ML Pipelines \| Python, TensorFlow, LangChain \| Open to opp |
