...
| 13 | [Arize-ai/openinference](https://github.com/Arize-ai/openinference) | 1220 | Python | 2026-09-15 | OpenTelemetry Instrumentation for AI Observability |
...
| 21 | [garcetemedinamateoandres-sketch/agent-deployment-orchestrator](https://github.com/garcetemedinamateoandres-sketch/agent-deployment-orchestrator) | 1 | HTML | 2026-09-15 | 🚀 AI Agent Deployment on GCP 2026: Fast-Track Production Templates & CI/CD |
...
| 23 | [vllm-project/vllm-ascend](https://github.com/vllm-project/vllm-ascend) | 2829 | C++ | 2026-09-15 | Community maintained hardware plugin for vLLM on Ascend |
| 24 | [babaliauskas/evalshift-action](https://github.com/babaliauskas/evalshift-action) | 0 | Python | 2026-09-15 | GitHub Action for LLM migration and regression testing — runs your golden suite on every PR and fails the check on model |
| 25 | [babaliauskas/evalshift-sdk](https://github.com/babaliauskas/evalshift-sdk) | 0 | Python | 2026-09-15 | Open-source capture SDK for AI agents — records model and tool calls to build golden suites for LLM migration and regres |
| 26 | [GetBusbar/busbar](https://github.com/GetBusbar/busbar) | 151 | Rust | 2026-09-15 | The execution control plane for AI agents. Govern every model request, MCP tool call, A2A delegation, and downstream act |
| 27 | [hpnkv/a11](https://github.com/hpnkv/a11) | 9 | C++ | 2026-09-15 | A streaming action runtime for AI agents, model serving, and multimodal APIs |
| 28 | [anthony-chaudhary/fak](https://github.com/anthony-chaudhary/fak) | 38 | Go | 2026-09-15 | Agentic Runtime |
| 29 | [mozilla-ai/otari](https://github.com/mozilla-ai/otari) | 463 | Python | 2026-09-15 | Open-source, OpenAI-compatible LLM gateway you run yourself. One endpoint for 40+ providers, with virtual keys, budgets, |
| 30 | [langwatch/langwatch](https://github.com/langwatch/langwatch) | 4792 | TypeScript | 2026-09-15 | The platform for LLM evaluations and AI agent testing |
...
| 32 | [ishandutta2007/Awesome-Prompt-Management-Platform](https://github.com/ishandutta2007/Awesome-Prompt-Management-Platform) | 4 | — | 2026-09-15 | Top Prompt Management Platform (Opensource) 🌟 Star if you like it! 🌟 |
| 33 | [yuzhiquan/llm-pipeline-on-kubernetes](https://github.com/yuzhiquan/llm-pipeline-on-kubernetes) | 0 | Python | 2026-09-15 | A runnable four-stage LLM pipeline on Kubernetes (data, SFT, batch inference, serving) with KubeRay + Ray + PyTorch + vL |
| 34 | [alibaba/rtp-llm](https://github.com/alibaba/rtp-llm) | 1336 | Python | 2026-09-15 | RTP-LLM: Alibaba's high-performance LLM inference engine for diverse applications. |
| 35 | [MakazhanAlpamys/Soup](https://github.com/MakazhanAlpamys/Soup) | 6590 | Python | 2026-09-15 | Fine-tune LLMs from one YAML. Layer streaming trains an 8B model on a 4 GB laptop GPU. |
...
| 37 | [ngu-gif/genai-role-playbook](https://github.com/ngu-gif/genai-role-playbook) | 1 | HTML | 2026-09-15 | GenAI Career Roadmap 2026 🚀 \| AI Job Paths & Skills Guide |
| 38 | [redevops-io/agentic-os](https://github.com/redevops-io/agentic-os) | 2 | Python | 2026-09-15 | The control plane for the redevops.io Agentic Business OS — Mission Runtime kernel (Python + Go), Projects cockpit, cost |
...
| 40 | [ndom91/llama-dash](https://github.com/ndom91/llama-dash) | 18 | TypeScript | 2026-09-15 | The operations layer for your local LLM stack |
| 41 | [ComposioHQ/composio](https://github.com/ComposioHQ/composio) | 30190 | TypeScript | 2026-09-15 | Composio powers 1000+ toolkits, tool search, context management, authentication, and a sandboxed workbench to help you b |
| 42 | [domondi1/inferrail](https://github.com/domondi1/inferrail) | 0 | Python | 2026-09-15 | Self-hosted, OpenAI-compatible LLM gateway that turns every request into a payload-free, attributable cost receipt — no  |
| 43 | [Abilityai/trinity](https://github.com/Abilityai/trinity) | 546 | Python | 2026-09-15 | Self-hosted AI Agents Platform supporting Claude Code, Codex, Gemini agents. Apache 2.0.   |
| 44 | [axiom-llc/axiom-apex](https://github.com/axiom-llc/axiom-apex) | 2 | Python | 2026-09-15 | Deterministic agent effect-execution kernel with bounded tools, durable effects, recovery, replay, tracing, MCP, and mul |
| 45 | [iblai/os](https://github.com/iblai/os) | 18 | TypeScript | 2026-09-15 | Enables organizations to create and deploy customizable AI agents with support for multiple LLM providers, real-time cha |
| 46 | [dataelement/bisheng](https://github.com/dataelement/bisheng) | 11968 | Python | 2026-09-15 | BISHENG is an open LLM devops platform for next generation Enterprise AI applications. Powerful and comprehensive featur |
| 47 | [truera/trulens](https://github.com/truera/trulens) | 3552 | Python | 2026-09-15 | Evaluation and Tracking for LLM Experiments and AI Agents |
| 48 | [mesedi-ai/mesedi](https://github.com/mesedi-ai/mesedi) | 0 | Go | 2026-09-15 | Drop-in observability + guardrails for autonomous AI agents. One-line SDK wrap catches 20+ named failure classes — loops |
| 49 | [SynaLinks/synalinks](https://github.com/SynaLinks/synalinks) | 457 | Python | 2026-09-15 | From idea to production in just few lines: Graph-Based Programmable Neuro-Symbolic LM Framework - a production-first LM  |
