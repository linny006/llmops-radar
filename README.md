...
| 22 | [runcycles/cycles-server-events](https://github.com/runcycles/cycles-server-events) | 1 | Java | 2026-07-20 | Signed webhook/event delivery for Cycles — retries, HMAC, replay, audit, governance events |
| 23 | [runcycles/cycles-dashboard](https://github.com/runcycles/cycles-dashboard) | 0 | TypeScript | 2026-07-20 | AI agent governance dashboard for Cycles — budgets, action authority, tenants, webhooks, reservations, audit |
| 24 | [JavisBot-Service/javis-transparency](https://github.com/JavisBot-Service/javis-transparency) | 1 | Python | 2026-07-20 | Third-party-verifiable model-authenticity audit for the javis.bot Claude/GPT relay — open-source probe, runs on GitHub A |
| 25 | [Rajeev-Shyam/Quellgeist](https://github.com/Rajeev-Shyam/Quellgeist) | 1 | Python | 2026-07-20 | Incident-triage agent that cites real evidence or abstains — model-agnostic, read-only MCP servers, frontier-competitive |
...
| 27 | [project-arbr/arbr-control-plane](https://github.com/project-arbr/arbr-control-plane) | 4 | JavaScript | 2026-07-20 | Open-source LLM control plane: observe every call, recommend savings, then apply only human-approved, reversible routing |
| 28 | [gabrielk83/AntCV](https://github.com/gabrielk83/AntCV) | 0 | JavaScript | 2026-07-20 | Multi-agent job application orchestration platform with provider routing, validation, provenance, and ATS-aware document |
| 29 | [yzhao062/auditable](https://github.com/yzhao062/auditable) | 16 | Python | 2026-07-20 | Audit any agent decision across its past, present, and future, on one typed graph. |
| 30 | [dataelement/bisheng](https://github.com/dataelement/bisheng) | 11700 | Python | 2026-07-20 | BISHENG is an open LLM devops platform for next generation Enterprise AI applications. Powerful and comprehensive featur |
| 31 | [mfow/llm-temporal-worker](https://github.com/mfow/llm-temporal-worker) | 0 | Go | 2026-07-20 | Temporal workers and clients for wrapping access to different LLMs |
| 32 | [aantenore/truthlease](https://github.com/aantenore/truthlease) | 0 | Python | 2026-07-20 | Deterministic coherence control plane that blocks AI agents from acting on stale decisions after their dependencies chan |
| 33 | [Unadventurous-concertina802/arcadia-win-script-execute](https://github.com/Unadventurous-concertina802/arcadia-win-script-execute) | 0 | HTML | 2026-07-20 | Execute Roblox Lua scripts on Windows with this compact, keyless runner featuring a built-in library of over 500 scripts |
| 34 | [bj-qizhi/trigix](https://github.com/bj-qizhi/trigix) | 3 | Rust | 2026-07-20 | AI-native workflow automation platform — Rust execution engine, 180 node types, visual canvas |
| 35 | [sidsri14/driftguard](https://github.com/sidsri14/driftguard) | 0 | Rust | 2026-07-20 | Local-first Rust CI guard for environment drift and AI prompt output contracts. |
| 36 | [runcycles/cycles-server](https://github.com/runcycles/cycles-server) | 3 | Java | 2026-07-20 | Self-hosted runtime authority server for AI agents — budgets, risk, actions, tenant isolation |
| 37 | [cuihuan/awesome-ai-gateway](https://github.com/cuihuan/awesome-ai-gateway) | 54 | HTML | 2026-07-20 | ⚡ Awesome AI Gateway — curated comparison of 100+ AI gateways & LLM proxies (LiteLLM, OpenRouter, Portkey, Kong, Higress |
...
| 39 | [mozilla-ai/otari](https://github.com/mozilla-ai/otari) | 301 | Python | 2026-07-20 | Open-source, OpenAI-compatible LLM gateway you run yourself. One endpoint for 40+ providers, with virtual keys, budgets, |
| 40 | [golikovichev/pytest-resilience-agent](https://github.com/golikovichev/pytest-resilience-agent) | 0 | Python | 2026-07-20 | pytest plugin that runs your LLM app under controlled chaos (timeouts, brownouts, rate limits, MCP errors, composed fail |
...
| 42 | [runcycles/cycles-docs](https://github.com/runcycles/cycles-docs) | 4 | Vue | 2026-07-20 | Documentation for Cycles — AI agent governance, runtime budget, action authority, MCP integration |
