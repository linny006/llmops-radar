...
| 23 | [ywutian/agent-spend-collector](https://github.com/ywutian/agent-spend-collector) | 2 | Python | 2026-07-07 | Read-only, cross-rail agent spend collector: LLM token + x402 payments in one FOCUS-shaped ledger, with anomaly detectio |
...
| 25 | [maximhq/bifrost](https://github.com/maximhq/bifrost) | 6331 | Go | 2026-07-07 | Fastest enterprise AI gateway (50x faster than LiteLLM) with adaptive load balancer, cluster mode, guardrails, 1000+ mod |
| 26 | [syntactic-orleanism949/logal-rag](https://github.com/syntactic-orleanism949/logal-rag) | 1 | — | 2026-07-07 | Build a local intelligent customer service system that uses Retrieval Augmented Generation to answer user questions from |
| 27 | [Roseapplemutualopposition5427/rag-llamaindex-qdrant-docker](https://github.com/Roseapplemutualopposition5427/rag-llamaindex-qdrant-docker) | 0 | Dockerfile | 2026-07-07 | Build a multi-collection RAG system using LlamaIndex and Qdrant in a Docker environment. |
| 28 | [hensu-project/hensu](https://github.com/hensu-project/hensu) | 11 | Java | 2026-07-07 | Infrastructure-as-code for AI agent workflows |
| 29 | [Fauniethermal3522/agentic-dart](https://github.com/Fauniethermal3522/agentic-dart) | 1 | Python | 2026-07-07 | Automate digital forensics and incident response tasks using an autonomous agent aligned with MITRE ATT&CK frameworks. |
| 30 | [crewhaus/factory](https://github.com/crewhaus/factory) | 2 | TypeScript | 2026-07-07 | Open-source compiler for AI agents. Write one crewhaus.yaml; compile it to a CLI, a Slack bot, and an eval harness from  |
| 31 | [promptfoo/promptfoo](https://github.com/promptfoo/promptfoo) | 23008 | TypeScript | 2026-07-07 | Test your prompts, agents, and RAGs. Red teaming/pentesting/vulnerability scanning for AI. Compare performance of GPT, C |
| 32 | [affkoul/agentforge-runtime](https://github.com/affkoul/agentforge-runtime) | 1 | Python | 2026-07-07 | AgentForge Protocol + Cloud: create, run, monetize, evaluate, and operate AI agents across APIs, marketplaces, workflows |
| 33 | [retardingforcerightbank635/dm-gateway-bot](https://github.com/retardingforcerightbank635/dm-gateway-bot) | 0 | Python | 2026-07-07 | Route Telegram DMs through a bot with emoji captcha, verified message relay, and owner reply support to block spam and k |
...
| 39 | [dshakes/distil](https://github.com/dshakes/distil) | 1 | Python | 2026-07-07 | Compression with a quality contract — cache-aware, causally-pruned LLM context compression for agentic runtimes, certifi |
...
| 41 | [Orlyoxidized462/py-prompt-versioner](https://github.com/Orlyoxidized462/py-prompt-versioner) | 1 | Python | 2026-07-07 | Version AI prompts in Markdown, inject variables with Jinja2, and manage prompt metadata with strict validation and a CL |
...
| 43 | [recordrnase224/brix-protocol](https://github.com/recordrnase224/brix-protocol) | 1 | Python | 2026-07-07 | Build runtime reliability guards for LLM pipelines with one wrap() call and configurable protection against common produ |
| 44 | [Citrous-districtline59/agent-trace](https://github.com/Citrous-districtline59/agent-trace) | 0 | Python | 2026-07-07 | Capture and replay every AI agent tool call, prompt, and response to trace sessions and debug complex workflows with ful |
| 45 | [Anideep-Kalia/Multi-Model-AI-Gateway](https://github.com/Anideep-Kalia/Multi-Model-AI-Gateway) | 1 | Python | 2026-07-07 | Multi-provider LLM gateway with rule-based complexity routing, response caching, automatic failover, rate limiting, and  |
...
| 49 | [optidev-ai/llm-cost-dashboard](https://github.com/optidev-ai/llm-cost-dashboard) | 0 | TypeScript | 2026-07-07 | Open-source LLM cost & usage governance dashboard — track, allocate & control spend across teams, models & providers. Bu |
| 50 | [ComposioHQ/composio](https://github.com/ComposioHQ/composio) | 29126 | TypeScript | 2026-07-07 | Composio powers 1000+ toolkits, tool search, context management, authentication, and a sandboxed workbench to help you b |
<!-- TRACKER_TABLE_END -->
