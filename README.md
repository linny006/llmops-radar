...
| 20 | [ictseoyoungmin/HADARA](https://github.com/ictseoyoungmin/HADARA) | 0 | TypeScript | 2026-06-19 | Portable agentic development workbench for evidence-backed, resumable AI-assisted software workflows. |
| 21 | [maximhq/bifrost](https://github.com/maximhq/bifrost) | 5898 | Go | 2026-06-19 | Fastest enterprise AI gateway (50x faster than LiteLLM) with adaptive load balancer, cluster mode, guardrails, 1000+ mod |
...
| 23 | [merido-dev/merido](https://github.com/merido-dev/merido) | 0 | Rust | 2026-06-19 | A fast, local-first AI gateway in Rust — route any coding CLI (Claude Code, Codex, Cursor…) to 40+ LLM providers, save t |
| 24 | [dinanjana/test-agent](https://github.com/dinanjana/test-agent) | 0 | TypeScript | 2026-06-19 | Framework-agnostic testing for AI agents — define pass/fail in plain English, run multi-turn tests, turn failures into a |
| 25 | [0xPlaygrounds/rig](https://github.com/0xPlaygrounds/rig) | 7676 | Rust | 2026-06-19 | ⚙️🦀 Build modular and scalable LLM Applications in Rust |
| 26 | [EvanAI0331/aigit](https://github.com/EvanAI0331/aigit) | 0 | Python | 2026-06-19 | Strict LLM-agent radar for discovering commercial opportunities from GitHub open-source signals. |
...
| 34 | [llmsyscore/llm-systems-manager](https://github.com/llmsyscore/llm-systems-manager) | 1 | Python | 2026-06-19 | LLM Systems Manager — real-time observability and control for LLM systems |
...
| 36 | [sergey-homenko/llm_cost_tracker](https://github.com/sergey-homenko/llm_cost_tracker) | 41 | Ruby | 2026-06-19 | Rails-native LLM cost ledger: track spend by provider, model, and feature with self-hosted storage and budget guardrails |
...
| 50 | [promptfoo/promptfoo](https://github.com/promptfoo/promptfoo) | 22369 | TypeScript | 2026-06-19 | Test your prompts, agents, and RAGs. Red teaming/pentesting/vulnerability scanning for AI. Compare performance of GPT, C |
<!-- TRACKER_TABLE_END -->
