...
|---|------|---|------|---------|-------------|
| 1 | [BerriAI/litellm](https://github.com/BerriAI/litellm) | 56767 | Python | 2026-08-19 | The fastest, litest AI Gateway. Rust core with Python SDK. Call 100+ LLM APIs in OpenAI (or native) format with cost tra |
| 2 | [babaliauskas/evalshift-cli](https://github.com/babaliauskas/evalshift-cli) | 4 | Python | 2026-08-19 | Open-source LLM migration and regression testing for AI agents. Compare models, detect tool-call regressions, and gate m |
...
| 5 | [langfuse/langfuse-workshop](https://github.com/langfuse/langfuse-workshop) | 38 | TypeScript | 2026-08-19 | End-to-end Langfuse workshop using a TypeScript Agent to teach the AI engineering loop: tracing, prompt management, moni |
...
| 8 | [hanyeol/model-compose](https://github.com/hanyeol/model-compose) | 76 | Python | 2026-08-19 | Deploy production-ready AI services in minutes. One YAML file for agents, RAG pipelines, and MCP servers — run anywhere. |
| 9 | [mozilla-ai/otari](https://github.com/mozilla-ai/otari) | 397 | Python | 2026-08-19 | Open-source, OpenAI-compatible LLM gateway you run yourself. One endpoint for 40+ providers, with virtual keys, budgets, |
...
| 21 | [ComposioHQ/composio](https://github.com/ComposioHQ/composio) | 29785 | TypeScript | 2026-08-19 | Composio powers 1000+ toolkits, tool search, context management, authentication, and a sandboxed workbench to help you b |
| 22 | [promptfoo/promptfoo](https://github.com/promptfoo/promptfoo) | 24383 | TypeScript | 2026-08-19 | Test your prompts, agents, and RAGs. Red teaming/pentesting/vulnerability scanning for AI. Compare performance of GPT, C |
...
| 34 | [rajiyengar-research/enterprise-ai-control-plane](https://github.com/rajiyengar-research/enterprise-ai-control-plane) | 0 | Python | 2026-08-19 | Policy-driven AI model routing with explainable decisions, SLA-aware optimization, and congestion evaluation. |
| 35 | [Arize-ai/phoenix](https://github.com/Arize-ai/phoenix) | 11117 | Python | 2026-08-19 | AI Observability & Evaluation |
| 36 | [JoniMartin27/lookspan](https://github.com/JoniMartin27/lookspan) | 7 | TypeScript | 2026-08-19 | Local-first observability dashboard for AI agents. MCP-native. Look at every span your agents emit. |
| 37 | [QuesmaOrg/awesome-ai-tokenomics](https://github.com/QuesmaOrg/awesome-ai-tokenomics) | 149 | Python | 2026-08-19 | A curated list of tools, benchmarks, papers, and copy-paste configs for AI token costs: what tokens cost, where they get |
| 38 | [0xPlaygrounds/rig](https://github.com/0xPlaygrounds/rig) | 8322 | Rust | 2026-08-19 | ⚙️🦀 Build modular and scalable LLM Applications in Rust |
...
| 40 | [richardh8/darkest_factory](https://github.com/richardh8/darkest_factory) | 0 | Python | 2026-08-19 | Two Claude Code plugins that take a business idea to production and refuse to let a model's guess masquerade as a fact.  |
| 41 | [tanveerkanala-cmd/ai-calibrator](https://github.com/tanveerkanala-cmd/ai-calibrator) | 0 | Python | 2026-08-19 | Turn your knowledge and standards into a tested, reliable AI — by interview, not by prompting. |
| 42 | [thanhpt1110/claude-for-poor-folks](https://github.com/thanhpt1110/claude-for-poor-folks) | 2 | JavaScript | 2026-08-19 | Live cost, token and quota meter for Claude Code — budget gate, runaway-loop burn-rate alarm, and prompt-cache leak dete |
...
| 44 | [TheWerbinator/promptforge](https://github.com/TheWerbinator/promptforge) | 0 | Python | 2026-08-19 | Multi-tenant LLM prompt management + evaluation platform with a RAG agent. Versioned prompts, batch evals (4 judges), li |
| 45 | [api-evangelist/zenml](https://github.com/api-evangelist/zenml) | 0 | — | 2026-08-19 | ZenML is an open-source MLOps and LLMOps framework that unifies machine learning and generative AI workflows through a s |
...
| 49 | [MakazhanAlpamys/Soup](https://github.com/MakazhanAlpamys/Soup) | 2437 | Python | 2026-08-19 | Fine-tune LLMs from one YAML. Layer streaming trains an 8B model on a 4 GB laptop GPU. |
