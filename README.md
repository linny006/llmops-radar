...
| 25 | [patibandlavenkatamanideep/evalseal](https://github.com/patibandlavenkatamanideep/evalseal) | 2 | Python | 2026-09-21 | Git-style receipts for LLM evals: measure variance, capture provenance, detect flaky verdicts, and verify results in CI |
| 26 | [dataelement/bisheng](https://github.com/dataelement/bisheng) | 11992 | Python | 2026-09-21 | BISHENG is an open LLM devops platform for next generation Enterprise AI applications. Powerful and comprehensive featur |
| 27 | [Guruexpl8276/LLM_Inference_Lab](https://github.com/Guruexpl8276/LLM_Inference_Lab) | 0 | Python | 2026-09-21 | Measure local LLM inference performance by tracking TTFT, TPOT, and throughput with this research-grade dashboard for Ol |
...
| 30 | [wordenneapolitan768/llm-pricing](https://github.com/wordenneapolitan768/llm-pricing) | 1 | — | 2026-09-21 | Track standardized pricing for 300+ LLM APIs in one JSON file for cost tools, comparisons, and billing dashboards |
| 31 | [Orlyoxidized462/py-prompt-versioner](https://github.com/Orlyoxidized462/py-prompt-versioner) | 1 | Python | 2026-09-21 | Version AI prompts in Markdown, inject variables with Jinja2, and manage prompt metadata with strict validation and a CL |
...
| 34 | [Citrous-districtline59/agent-trace](https://github.com/Citrous-districtline59/agent-trace) | 0 | Python | 2026-09-21 | Capture and replay every AI agent tool call, prompt, and response to trace sessions and debug complex workflows with ful |
...
| 37 | [BerriAI/litellm](https://github.com/BerriAI/litellm) | 59308 | Python | 2026-09-21 | The fastest, litest AI Gateway. Rust core with Python SDK. Call 100+ LLM APIs in OpenAI (or native) format with cost tra |
| 38 | [olivaresai/olivares](https://github.com/olivaresai/olivares) | 7 | Go | 2026-09-21 | Ground truth for enterprise AI — discover, operate and govern every agent, session, model and MCP already running on you |
| 39 | [csdeepak/HandCode](https://github.com/csdeepak/HandCode) | 0 | Python | 2026-09-21 | Effect-safety and cost control plane for long-running LLM agents. A crashed agent never commits twice — verified at nine |
| 40 | [rhesis-ai/rhesis](https://github.com/rhesis-ai/rhesis) | 392 | Python | 2026-09-21 | The collaboration layer for AI teams: domain experts annotate and review agent behavior, engineers improve the agent fro |
| 41 | [openlit/openlit](https://github.com/openlit/openlit) | 2780 | TypeScript | 2026-09-21 | Open-source observability & evaluation platform for AI agents and coding agents. Trace LLMs, tools, prompts, costs & age |
...
| 43 | [mloda-ai/mloda](https://github.com/mloda-ai/mloda) | 88 | Python | 2026-09-21 | mloda.ai - Open Data Access for AI and ML. Plugin-based. Traceable. Framework-agnostic. |
| 44 | [cognifityai/verdict](https://github.com/cognifityai/verdict) | 0 | Python | 2026-09-21 | Open-source LLM observability and drift detection for AI apps |
| 45 | [DucLong06/ai-infra-roadmap](https://github.com/DucLong06/ai-infra-roadmap) | 0 | — | 2026-09-21 | AI infrastructure learning roadmap: DevOps → MLOps → NVIDIA GPU → networking → security → LLMOps → AI data center |
...
| 47 | [theagentplane/tokenops](https://github.com/theagentplane/tokenops) | 76 | Python | 2026-09-21 | Run-aware token governance for multi-agent systems. |
