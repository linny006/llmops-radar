...
| 23 | [kuhlman-labs/fishhawk](https://github.com/kuhlman-labs/fishhawk) | 5 | Go | 2026-07-31 | A governed, auditable workflow engine for an agent-driven software factory. |
| 24 | [holasoymalva/manyllm-app](https://github.com/holasoymalva/manyllm-app) | 0 | Swift | 2026-07-31 | Native SwiftUI application for iPhone & iPad to run and connect LLMs locally (via Ollama) and remotely (OpenAI, Anthropi |
...
| 27 | [ShenSeanChen/waku-agent](https://github.com/ShenSeanChen/waku-agent) | 674 | Python | 2026-07-31 | Waku Waku! Waku agent is your personal AI agent, on your own laptop, in code you can read in an afternoon — harness + lo |
...
| 29 | [apache/hamilton](https://github.com/apache/hamilton) | 2555 | Jupyter Notebook | 2026-07-31 | Apache Hamilton helps data scientists and engineers define testable, modular, self-documenting dataflows, that encode li |
| 30 | [mlflow/mlflow](https://github.com/mlflow/mlflow) | 27306 | Python | 2026-07-31 | The open source AI engineering platform for agents, LLMs, and ML models. MLflow enables teams of all sizes to debug, eva |
| 31 | [TAIPANBOX/tokenfuse](https://github.com/TAIPANBOX/tokenfuse) | 1 | Rust | 2026-07-31 | TokenFuse — runtime control for AI agents: per-run budgets, loop detection, burn forecast, kill-switch. Observability sh |
| 32 | [tkgo1599-max/llm-cost-router](https://github.com/tkgo1599-max/llm-cost-router) | 0 | Python | 2026-07-31 | Complexity-aware LLM router: easy prompts go to a cheap model, hard ones premium. 60.7% cost reduction at zero escalatio |
| 33 | [amro/evaling](https://github.com/amro/evaling) | 0 | Python | 2026-07-31 | CLI tool for comparing prompt variants and models |
| 34 | [apache/burr](https://github.com/apache/burr) | 2497 | Python | 2026-07-31 | Build applications that make decisions (chatbots, agents, simulations, etc...). Monitor, trace, persist, and execute on  |
| 35 | [buchk/TypeFerence](https://github.com/buchk/TypeFerence) | 0 | Go | 2026-07-31 | A typed coherence layer for portable organizational AI agents. |
...
| 37 | [tkgo1599-max/rag-quality-bench](https://github.com/tkgo1599-max/rag-quality-bench) | 0 | Python | 2026-07-31 | Retrieval-quality harness for RAG: recall@10 and MRR against labeled queries across chunkers and retrievers. Chunk size  |
| 38 | [tkgo1599-max/prompt-regression-gate](https://github.com/tkgo1599-max/prompt-regression-gate) | 0 | Python | 2026-07-31 | CI gate that blocks LLM prompt and model changes which regress on a golden eval suite. Three deterministic checks (token |
| 39 | [RafineriaAI/aos-workflow-gate](https://github.com/RafineriaAI/aos-workflow-gate) | 0 | Python | 2026-07-31 | GitHub Action + CLI for replayable CI/PR/release gate decisions - zero-config Self-Test turning checks, scanners, and AI |
| 40 | [Amitcoh1/agentbreaker](https://github.com/Amitcoh1/agentbreaker) | 4 | TypeScript | 2026-07-31 | Circuit breaker + hierarchical dollar budget for LangGraph agents. In-process, no proxy. |
| 41 | [DYAI2025/Plumbline](https://github.com/DYAI2025/Plumbline) | 6 | Shell | 2026-07-31 | Plumbline — a self-learning, customer-value-governed agile AI agent team for Claude Code. 87 subagents + skills, TDD def |
| 42 | [cubxxw/blog](https://github.com/cubxxw/blog) | 26 | CSS | 2026-07-31 | Write some excellent articles about AI, Agents, technology, products, marketing, some life reflections, and personal gro |
| 43 | [becloudready/workshops](https://github.com/becloudready/workshops) | 4 | HTML | 2026-07-31 | Hands-on AWS data lake and pipeline workshops for engineering teams. Glue, Redshift, Lake Formation, Databricks, LLMOps. |
...
| 45 | [vipulchinmay/llmops-evals](https://github.com/vipulchinmay/llmops-evals) | 0 | Python | 2026-07-31 | Lightweight, self-hosted LLMOps evaluation & observability platform with multi-provider tracking (OpenRouter, OpenAI, An |
| 46 | [vivek-541/vivek-541](https://github.com/vivek-541/vivek-541) | 3 | HTML | 2026-07-31 | AI Engineer building production-grade ML systems \| LLMs, RAG, ML Pipelines \| Python, TensorFlow, LangChain \| Open to opp |
...
| 48 | [ghourimarti/Product-Recommender-Engine](https://github.com/ghourimarti/Product-Recommender-Engine) | 0 | Python | 2026-07-31 | Conversational product recommender: one rating-aware ranking core, two retrieval backends - Qdrant hybrid RAG over your  |
| 49 | [psyb0t/aigate](https://github.com/psyb0t/aigate) | 10 | Shell | 2026-07-31 | A self-hosted AI platform — inference, tool use, browser automation, image generation, speech synthesis, transcription,  |
| 50 | [alexejsailer/agentic-nets](https://github.com/alexejsailer/agentic-nets) | 5 | Java | 2026-07-31 | Governed multi-agent runtime for Petri-net workflows, scoped agent permissions, durable state, and replayable execution. |
<!-- TRACKER_TABLE_END -->
