...
| 20 | [santiag6001/llm-engineering-platform](https://github.com/santiag6001/llm-engineering-platform) | 1 | Python | 2026-09-26 | Build production-ready LLM systems using FastAPI and llama.cpp with integrated streaming, evaluation, and observability  |
| 21 | [Frayagronomist166/LiteRT.js-Mocap](https://github.com/Frayagronomist166/LiteRT.js-Mocap) | 1 | — | 2026-09-26 | Track human movement in real-time using LiteRT.js and Three.js for browser-based 3D character animation without server d |
...
| 24 | [andrelair-platform/aisystemmaster](https://github.com/andrelair-platform/aisystemmaster) | 0 | TypeScript | 2026-09-26 | AI Systems Engineer Playbook — career roadmap, discipline references, and 3 flagship project specs for regulated-industr |
...
| 26 | [Amz34/awesome-agent-infrastructure](https://github.com/Amz34/awesome-agent-infrastructure) | 0 | Python | 2026-09-26 | A live-checked index of production-grade, self-hostable building blocks for AI agents and LLM workloads. |
...
| 35 | [JoniMartin27/lookspan](https://github.com/JoniMartin27/lookspan) | 7 | TypeScript | 2026-09-26 | Local-first observability dashboard for AI agents. MCP-native. Look at every span your agents emit. |
...
| 38 | [scttfrdmn/hf-bedrock-map](https://github.com/scttfrdmn/hf-bedrock-map) | 1 | Go | 2026-09-26 | Is a Hugging Face model already served by Amazon Bedrock? Daily-refreshed HF↔Bedrock mapping (US regions) with a free st |
...
| 40 | [GodMaking/fde](https://github.com/GodMaking/fde) | 1 | — | 2026-09-26 | FDE 前沿部署工程师 Skill —— 给 AI Agent 用的 AI 落地手册：六条铁律 + 九步工作流 + 13 份现场手册（选型/推理优化/分布式/成本/本体建模/合规/采纳运营） |
| 41 | [runcycles/cycles-docs](https://github.com/runcycles/cycles-docs) | 4 | Vue | 2026-09-26 | Documentation for Cycles — AI agent governance, runtime budget, action authority, MCP integration |
...
| 48 | [mlflow/mlflow](https://github.com/mlflow/mlflow) | 28141 | Python | 2026-09-26 | The open source AI engineering platform for agents, LLMs, and ML models. MLflow enables teams of all sizes to debug, eva |
| 49 | [llmspendguard/llm-spendguard](https://github.com/llmspendguard/llm-spendguard) | 0 | Python | 2026-09-26 | Know what an LLM job will cost before you run it — and prove your ledger matches the provider's bill. Pre-submit estimat |
| 50 | [empiredestroyer/AI-Prompt-Enhancer](https://github.com/empiredestroyer/AI-Prompt-Enhancer) | 2 | — | 2026-09-26 | 🚀 Enhance prompts effortlessly with AI-Prompt-Enhancer. Transform simple ideas into precise commands for optimal AI resu |
<!-- TRACKER_TABLE_END -->
