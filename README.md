...
| 30 | [clearml/clearml](https://github.com/clearml/clearml) | 6858 | Python | 2026-09-06 | ClearML - Auto-Magical CI/CD to streamline your AI workload. Experiment Management, Data Management, Pipeline, Orchestra |
...
| 33 | [promptfoo/promptfoo](https://github.com/promptfoo/promptfoo) | 24865 | TypeScript | 2026-09-06 | Test your prompts, agents, and RAGs. Red teaming/pentesting/vulnerability scanning for AI. Compare performance of GPT, C |
| 34 | [Arize-ai/phoenix](https://github.com/Arize-ai/phoenix) | 11346 | Python | 2026-09-06 | AI Observability & Evaluation |
| 35 | [acornops/acornops-deployment](https://github.com/acornops/acornops-deployment) | 2 | JavaScript | 2026-09-06 | Deployment orchestration for AcornOps, including Docker Compose, Kubernetes Helm charts, environment templates, and oper |
| 36 | [acornops/docs-website](https://github.com/acornops/docs-website) | 1 | MDX | 2026-09-06 | Public documentation site for AcornOps, including installation guides, architecture, operations, and release notes. |
| 37 | [kkrlstrm/model-eval-gate](https://github.com/kkrlstrm/model-eval-gate) | 1 | Python | 2026-09-06 | Versioned, eval-backed delegation policy for AI agents—prove what can leave the frontier model, enforce it in runtimes,  |
| 38 | [acornops/management-console](https://github.com/acornops/management-console) | 2 | TypeScript | 2026-09-06 | Management console for AcornOps, providing the browser UI for workspaces, targets, runs, agents, and platform operations |
| 39 | [acornops/control-plane](https://github.com/acornops/control-plane) | 2 | TypeScript | 2026-09-06 | AcornOps control plane service for authentication, workspace APIs, target registration, run orchestration, and agent coo |
| 40 | [avikalpg/byok-relay](https://github.com/avikalpg/byok-relay) | 54 | JavaScript | 2026-09-06 | Bring your own key (BYOK) relay to enable lightweight frontend-only apps to use LLMs using the user's API keys without h |
| 41 | [Abilityai/trinity](https://github.com/Abilityai/trinity) | 515 | Python | 2026-09-06 | Self-hosted AI Agents Platform supporting Claude Code, Codex, Gemini agents. Apache 2.0.   |
| 42 | [mloda-ai/mloda](https://github.com/mloda-ai/mloda) | 85 | Python | 2026-09-06 | mloda.ai - Open Data Access for AI and ML. Plugin-based. Traceable. Framework-agnostic. |
| 43 | [runcycles/cycles-server](https://github.com/runcycles/cycles-server) | 4 | Java | 2026-09-06 | Self-hosted runtime authority server for AI agents — budgets, risk, actions, tenant isolation |
...
| 45 | [jasonneo99/agent-workflow](https://github.com/jasonneo99/agent-workflow) | 0 | TypeScript | 2026-09-06 | Portable BYO-model agent workflows for cost-aware, personalized software development automation across CLI, VS Code, Cur |
| 46 | [brandonhimpfen/awesome-llmops](https://github.com/brandonhimpfen/awesome-llmops) | 17 | Python | 2026-09-06 | A curated list of tools, frameworks, platforms, and resources for Large Language Model Operations (LLMOps). |
| 47 | [veritasfuji-japan/veritas_os](https://github.com/veritasfuji-japan/veritas_os) | 35 | Python | 2026-09-06 | VERITAS OS is an AI agent governance runtime for decision control, policy enforcement, approval workflows, audit trails, |
| 48 | [samarthputhraya/Modelpin](https://github.com/samarthputhraya/Modelpin) | 1 | Python | 2026-09-06 | Dependabot for AI models — replay your app's scenarios across a model migration and catch real behavioral regressions be |
| 49 | [cloudrift-ai/emmy](https://github.com/cloudrift-ai/emmy) | 80 | Python | 2026-09-06 | Optimized GPU compiler for LLM inference. Choose from a list of optimized recipes or optimize your own model via kernel  |
