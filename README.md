...
| 10 | [promptfoo/promptfoo](https://github.com/promptfoo/promptfoo) | 25039 | TypeScript | 2026-09-12 | Test your prompts, agents, and RAGs. Red teaming/pentesting/vulnerability scanning for AI. Compare performance of GPT, C |
| 11 | [Rickettsiayorkshirefog4963/still2rig-psd](https://github.com/Rickettsiayorkshirefog4963/still2rig-psd) | 0 | JavaScript | 2026-09-12 | Convert static anime images into structured, QA-checked PSDs with Codex, Colab GPU, and built-in motion preview. |
| 12 | [santiag6001/llm-engineering-platform](https://github.com/santiag6001/llm-engineering-platform) | 1 | Python | 2026-09-12 | Build production-ready LLM systems using FastAPI and llama.cpp with integrated streaming, evaluation, and observability  |
| 13 | [Frayagronomist166/LiteRT.js-Mocap](https://github.com/Frayagronomist166/LiteRT.js-Mocap) | 1 | — | 2026-09-12 | Track human movement in real-time using LiteRT.js and Three.js for browser-based 3D character animation without server d |
| 14 | [Soilbuilding-libraryroutine78/Gozar](https://github.com/Soilbuilding-libraryroutine78/Gozar) | 0 | Python | 2026-09-12 | Route LLM requests through a self-hosted, OpenAI-compatible gateway for local projects and team workflows. |
| 15 | [wordmiddling872/AI_Email_Generator](https://github.com/wordmiddling872/AI_Email_Generator) | 1 | Python | 2026-09-12 | Generate business emails locally using Python, Streamlit, and Ollama with this production-ready desktop application. |
| 16 | [Karinaclastic11/Drip-Lite-Client](https://github.com/Karinaclastic11/Drip-Lite-Client) | 1 | — | 2026-09-12 | Enhance Minecraft gameplay with this lightweight utility featuring aim assistance, ESP, and custom movement controls. |
| 17 | [Nihilisticdelusionoldboy87/loop-engineering-orange-book](https://github.com/Nihilisticdelusionoldboy87/loop-engineering-orange-book) | 2 | — | 2026-09-12 | Build automated agent systems that remove manual prompting by applying loop engineering principles for efficient softwar |
| 18 | [syntactic-orleanism949/logal-rag](https://github.com/syntactic-orleanism949/logal-rag) | 1 | — | 2026-09-12 | Build a local intelligent customer service system that uses Retrieval Augmented Generation to answer user questions from |
| 19 | [effecterelectricalplant87/LLM](https://github.com/effecterelectricalplant87/LLM) | 0 | — | 2026-09-12 | Build a GPT-style LLM in C# from scratch with clear, readable code for learning transformer internals and training basic |
| 20 | [Rosalyndfaithful716/Guardrail](https://github.com/Rosalyndfaithful716/Guardrail) | 1 | TypeScript | 2026-09-12 | Scan AI-generated code for security, performance, and code quality issues before they ship |
...
| 24 | [BerriAI/litellm](https://github.com/BerriAI/litellm) | 58545 | Python | 2026-09-12 | The fastest, litest AI Gateway. Rust core with Python SDK. Call 100+ LLM APIs in OpenAI (or native) format with cost tra |
| 25 | [MakazhanAlpamys/Soup](https://github.com/MakazhanAlpamys/Soup) | 6160 | Python | 2026-09-12 | Fine-tune LLMs from one YAML. Layer streaming trains an 8B model on a 4 GB laptop GPU. |
...
| 30 | [maximhq/bifrost](https://github.com/maximhq/bifrost) | 7990 | Go | 2026-09-12 | Fastest enterprise AI gateway (50x faster than LiteLLM) with adaptive load balancer, cluster mode, guardrails, 1000+ mod |
| 31 | [KewalPra/agent-sdk](https://github.com/KewalPra/agent-sdk) | 1 | Python | 2026-09-12 | ⚙️ Simplify agent development with a straightforward for-loop framework, enabling efficient tool calls for your applicat |
...
| 40 | [Kakz/prometheus-llm](https://github.com/Kakz/prometheus-llm) | 6 | Python | 2026-09-12 | PrometheusLLM is a unique transformer architecture inspired by dignity and recursion. This project aims to explore new f |
| 41 | [mlflow/mlflow](https://github.com/mlflow/mlflow) | 27918 | Python | 2026-09-12 | The open source AI engineering platform for agents, LLMs, and ML models. MLflow enables teams of all sizes to debug, eva |
...
| 43 | [taishan666/MaxKB4j](https://github.com/taishan666/MaxKB4j) | 128 | Java | 2026-09-12 | MaxKB4j is an open-source LLMOps platform for LLM workflow applications and RAG developed based on the Java language. Th |
| 44 | [Jdawgboo/inference-cost-ledger](https://github.com/Jdawgboo/inference-cost-ledger) | 0 | Python | 2026-09-12 | Offline token and cost ledger for tracking model inference spend from normalized JSON records. |
| 45 | [tahircengiz/grafana-dashboards](https://github.com/tahircengiz/grafana-dashboards) | 0 | Python | 2026-09-12 | Kendi donanımında koşan LLM altyapısı için Grafana + Prometheus panoları: gecikmeyi ve hatayı istemci / geçit / backend  |
