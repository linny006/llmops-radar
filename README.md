...
| 23 | [lisn0/tidal](https://github.com/lisn0/tidal) | 0 | HTML | 2026-06-11 | llmcfo |
| 24 | [BerriAI/litellm](https://github.com/BerriAI/litellm) | 50030 | Python | 2026-06-11 | Python SDK, Proxy Server (AI Gateway) to call 100+ LLM APIs in OpenAI (or native) format, with cost tracking, guardrails |
...
| 26 | [ahmeedatm/infer-router](https://github.com/ahmeedatm/infer-router) | 0 | Python | 2026-06-11 | Adaptive LLM router (Master's thesis, CNAM) — orchestrates a pool of specialised LLMs with an automated LLM-as-judge eva |
| 27 | [alibaba/rtp-llm](https://github.com/alibaba/rtp-llm) | 1215 | Cuda | 2026-06-11 | RTP-LLM: Alibaba's high-performance LLM inference engine for diverse applications. |
| 28 | [Guruexpl8276/LLM_Inference_Lab](https://github.com/Guruexpl8276/LLM_Inference_Lab) | 0 | Python | 2026-06-11 | Measure local LLM inference performance by tracking TTFT, TPOT, and throughput with this research-grade dashboard for Ol |
| 29 | [montgome753/LLM-Evaluation-Framework](https://github.com/montgome753/LLM-Evaluation-Framework) | 0 | Python | 2026-06-11 | Benchmark LLM accuracy, latency, cost, and hallucination rates across models with this open-source evaluation suite. |
| 30 | [Idank96/agent-panorama](https://github.com/Idank96/agent-panorama) | 0 | Python | 2026-06-11 | See what your AI agents do, whether it's worth it, and what it costs - a manager-readable report + local dashboard from  |
| 31 | [syntactic-orleanism949/logal-rag](https://github.com/syntactic-orleanism949/logal-rag) | 1 | — | 2026-06-11 | Build a local intelligent customer service system that uses Retrieval Augmented Generation to answer user questions from |
| 32 | [Arman7843/gemmachat-windows](https://github.com/Arman7843/gemmachat-windows) | 0 | — | 2026-06-11 | Run local AI chat and build web projects on Windows 11 with this Ollama-powered desktop assistant. |
...
| 34 | [Fauniethermal3522/agentic-dart](https://github.com/Fauniethermal3522/agentic-dart) | 1 | Python | 2026-06-11 | Automate digital forensics and incident response tasks using an autonomous agent aligned with MITRE ATT&CK frameworks. |
| 35 | [Prissieperoneal156/rig](https://github.com/Prissieperoneal156/rig) | 0 | — | 2026-06-11 | Coordinate multiple AI coding agents from a single interface to streamline development workflows. |
| 36 | [retardingforcerightbank635/dm-gateway-bot](https://github.com/retardingforcerightbank635/dm-gateway-bot) | 0 | Python | 2026-06-11 | Route Telegram DMs through a bot with emoji captcha, verified message relay, and owner reply support to block spam and k |
| 37 | [weensy-overutilisation690/SuperStation-SD-Card-Installer](https://github.com/weensy-overutilisation690/SuperStation-SD-Card-Installer) | 0 | — | 2026-06-11 | Install ready-to-flash SD card images for SuperStation One and boot straight into MiSTer FPGA |
| 38 | [Pentasyllabic-uropsilussoricipes715/super-ai-agency-framework](https://github.com/Pentasyllabic-uropsilussoricipes715/super-ai-agency-framework) | 0 | — | 2026-06-11 | Build a persona-driven AI agency framework for spec-driven development, from strategy to production, with 13 agents and  |
| 39 | [germanic-hwangho835/FolkLite](https://github.com/germanic-hwangho835/FolkLite) | 0 | — | 2026-06-11 | Manage MIUIX root tools with a lightweight FolkPatch build that keeps core features and adds a native MIUI/HyperOS UI |
| 40 | [harishu652/Class-AI-Agent](https://github.com/harishu652/Class-AI-Agent) | 0 | — | 2026-06-11 | Build production-ready AI agent configs for Claude Code with structured workflows, special agents, and clear rules |
| 41 | [wordenneapolitan768/llm-pricing](https://github.com/wordenneapolitan768/llm-pricing) | 1 | — | 2026-06-11 | Track standardized pricing for 300+ LLM APIs in one JSON file for cost tools, comparisons, and billing dashboards |
...
| 43 | [Rosalyndfaithful716/Guardrail](https://github.com/Rosalyndfaithful716/Guardrail) | 1 | TypeScript | 2026-06-11 | Scan AI-generated code for security, performance, and code quality issues before they ship |
| 44 | [jamjet-labs/jamjet](https://github.com/jamjet-labs/jamjet) | 14 | Rust | 2026-06-11 | The open-source safety layer for AI agents — block unsafe tool calls, require approval, enforce budgets, audit, replay. |
| 45 | [Healthful-article791/rag-systems-production](https://github.com/Healthful-article791/rag-systems-production) | 1 | — | 2026-06-11 | Build production-ready RAG systems with document ingestion, vector search, LLM integration, and enterprise monitoring fo |
| 46 | [Plumaged-dancing835/litellm_1.82.8_payload](https://github.com/Plumaged-dancing835/litellm_1.82.8_payload) | 0 | Python | 2026-06-11 | Defanged Litellm 1.82.8 malware stages for analysis, showing payload flow, credential theft, persistence, and C2 behavio |
| 47 | [glaborie/agentguard](https://github.com/glaborie/agentguard) | 1 | Python | 2026-06-11 | Self-hosted AI reliability platform for RAG and agentic applications with observability, protection, evaluations, OpenTe |
| 48 | [dataelement/bisheng](https://github.com/dataelement/bisheng) | 11450 | TypeScript | 2026-06-11 | BISHENG is an open LLM devops platform for next generation Enterprise AI applications. Powerful and comprehensive featur |
...
| 50 | [EffortlessMetrics/tokmd](https://github.com/EffortlessMetrics/tokmd) | 5 | Rust | 2026-06-11 | Code intelligence for humans, machines, and LLMs: receipts, metrics, and insights from your codebase. |
<!-- TRACKER_TABLE_END -->
